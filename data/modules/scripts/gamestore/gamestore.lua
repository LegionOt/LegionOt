...
HomeBanners = {
    images = { "home/1.png", "home/2.png", "home/3.png", "home/4.png", "home/5.png", "home/6.png", "home/7.png", "home/8.png", "home/9.png", "home/10.png", "home/11.png", "home/12.png", "home/13.png", "home/14.png", "home/15.png", "home/16.png", "home/17.png", "home/18.png", "home/19.png", "home/20.png", "home/21.png", "home/22.png", "home/23.png", "home/24.png", "home/25.png", "home/26.png", "home/27.png", "home/28.png", "home/29.png", "home/30.png", "home/31.png", "home/32.png", "home/33.png", "home/34.png", "home/35.png", "home/36.png", "home/37.png", "home/38.png", "home/39.png", "home/40.png", "home/41.png", "home/42.png", "home/43.png", "home/44.png", "home/45.png", "home/46.png", "home/47.png", "home/48.png", "home/49.png", "home/50.png", "home/51.png", "home/52.png", "home/53.png", "home/54.png", "home/55.png" },
    delay = 1
}
...
GameStore.Categories = {
 ...
 --Premium Time
  ...
  name = "Equipments",
  rookgaard = true,
  subclasses = {"Lion set, Cobra set, News Items/Dracora"},
   },
-- News Items/Dracora
  {
  icons = { "Category_ExclusiveOffers.png" },
...
--- consumibles---
 {
   ...
   name = "Consumables",
   rookgaard = true,
   subclasses = {"Casks", "Exercise Weapons", "Kegs", "Potions"},
 }, 
 -- Casks
 {
 ...
 -- Exercise Weapons
   ...
   offers = {
        ...
        },
        {
          ...
          itemtype = 35280,
          charges = 3600,
          description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 3600 times a piece",
          type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
        },
        {
          icons = { "Exercise_Bow.png" },
        ...
        },
        {
          ...
          itemtype = 35286,
          charges = 18000,
          description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 18000 times a piece",
          type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
        },
        {
          icons = { "Exercise_Bow.png" },
...
--House 
  {
   ...
   name = "Houses",
   rookgaard = true,
   subclasses = {"Upgrades", "Hirelings", "Hirelings Dresses"},
 }, 
   ...
   offers = { 
        {
          ...
          itemtype = 36730,
          count = 1,
          description = "exp boost 50% por 1hr",
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        },		
        {
          icons = { "primal_bag.png" },
          ...
          itemtype = 36731,
          count = 1,
          description = "exp boost 100% por 1hr",
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        },
        {
          icons = { "primal_bag.png" },
          ...
          itemtype = 36732,
          count = 1,
          description = "exp boost 150% por 1hr",
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        },	
        {
          icons = { "primal_bag.png" },
          ...
          itemtype = 36733,
          count = 1,
          description = "exp boost 200% por 1hr",
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        },	
        {
          icons = { "primal_bag.png" },
          ...
          itemtype = 36734,
          count = 1,
          description = "exp boost 250% por 1hr",
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        },	
        {
          icons = { "primal_bag.png" },
          name = "exp boost random",
          price = 150,
          itemtype = 36741,
          count = 1,
          description = "when using this item you receive a random exp boost from 50% up to 250%",
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        },		
      },
   rookgaard = true,
...
-- Usefull Things  
  {   
   ...
   offers = { 
      {
         ...
         itemtype = 39757,
         charges = 1,
         description = "Addon doll just say !addon and chose it.",
         type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
       },
        {
   ...
   name = "Tournament",
   rookgaard = true,
   subclasses = {"New", "Decorations", "Furniture", "Exclusive Offers"},
  },
  ...
  { 
   ...
   offers = { 
   
        {
          ...
          type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
          coinType = GameStore.CointType.Tournament,zzzzzzzzzzzz
        },
        {
