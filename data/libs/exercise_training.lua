ExerciseWeaponsTable = {
	-- MELE
	[28540] = { skill = SKILL_SWORD, skill2 = SKILL_SHIELD },
	[28552] = { skill = SKILL_SWORD, skill2 = SKILL_SHIELD },
	[35279] = { skill = SKILL_SWORD, skill2 = SKILL_SHIELD },
	[35285] = { skill = SKILL_SWORD, skill2 = SKILL_SHIELD },
	[28553] = { skill = SKILL_AXE, skill2 = SKILL_SHIELD },
	[28541] = { skill = SKILL_AXE, skill2 = SKILL_SHIELD },
	[35280] = { skill = SKILL_AXE, skill2 = SKILL_SHIELD },
	[35286] = { skill = SKILL_AXE, skill2 = SKILL_SHIELD },
	[28554] = { skill = SKILL_CLUB, skill2 = SKILL_SHIELD },
	[28542] = { skill = SKILL_CLUB, skill2 = SKILL_SHIELD },
	[35281] = { skill = SKILL_CLUB, skill2 = SKILL_SHIELD },
	[35287] = { skill = SKILL_CLUB, skill2 = SKILL_SHIELD },
	-- ROD
	...
	-- RANGE
	[28543] = { skill = SKILL_DISTANCE, skill2 = SKILL_SHIELD, effect = CONST_ANI_SIMPLEARROW, allowFarUse = true },
	[28555] = { skill = SKILL_DISTANCE, skill2 = SKILL_SHIELD, effect = CONST_ANI_SIMPLEARROW, allowFarUse = true },
	[35282] = { skill = SKILL_DISTANCE, skill2 = SKILL_SHIELD, effect = CONST_ANI_SIMPLEARROW, allowFarUse = true },
	[35288] = { skill = SKILL_DISTANCE, skill2 = SKILL_SHIELD, effect = CONST_ANI_SIMPLEARROW, allowFarUse = true },
	-- WAND
...
function ExerciseEvent(playerId, tilePosition, weaponId, dummyId)
	...
	if bonusDummy then bonusDummy = 0.8 else bonusDummy = 1 end

	if isMagic then
		player:addManaSpent(500 * bonusDummy)
	else
		player:addSkillTries(ExerciseWeaponsTable[weaponId].skill, 7 * bonusDummy)
		player:addSkillTries(ExerciseWeaponsTable[weaponId].skill2, 7 * bonusDummy)
	end
