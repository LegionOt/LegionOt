...
monster.description = "Crazy Dracora Pumpkin"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 1000, attack = 2000},
	{name ="combat", interval = 3000, chance = 18, type = COMBAT_MANADRAIN, minDamage = -100, maxDamage = -800, range = 7, effect = CONST_ME_MAGIC_RED, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -100, maxDamage = -900, radius = 7, effect = CONST_ME_POISONAREA, target = true},
	{name ="combat", interval = 3000, chance = 14, type = COMBAT_ENERGYDAMAGE, minDamage = -40, maxDamage = -800, radius = 7, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -30, maxDamage = -800, radius = 8, effect = CONST_ME_POFF, target = false},
	{name ="combat", interval = 3000, chance = 12, type = COMBAT_EARTHDAMAGE, minDamage = -100, maxDamage = -900, length = 8, spread = 3, effect = CONST_ME_PLANTATTACK, target = true},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -100, maxDamage = -700, length = 6, spread = 3, effect = CONST_ME_HITBYPOISON, target = false},
