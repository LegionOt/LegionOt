...
{name ="melee", interval = 2000, chance = 100, minDamage = -200, maxDamage = -1100},
	{name ="combat", interval = 1000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -1100, radius = 4, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="combat", interval = 1000, chance = 50, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -1100, length = 8, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 1300, chance = 12, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -1100, range = 5, length = 5, spread = 3, effect = CONST_ME_WHITE_ENERGY_SPARK, target = true}
}
