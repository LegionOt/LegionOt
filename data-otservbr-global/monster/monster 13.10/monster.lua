...
monster.voices = {
	interval = 5000,
	chance = 10,
	{text = "Mosnter!", yell = true},
	{text = "Mosnter", yell = false}
}
...
monster.defenses = {
	defense = 30,
	armor = 30,
	{name ="outfit", interval = 1000, chance = 579, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Hydra"},
	{name ="outfit", interval = 1000, chance = 610, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Captain Jones"},
	{name ="outfit", interval = 1000, chance = 588, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "rat"},
	{name ="outfit", interval = 1000, chance = 691, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Spitter"},
	{name ="outfit", interval = 1000, chance = 597, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Dragon"},
	{name ="outfit", interval = 1000, chance = 489, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Cyclops"},
