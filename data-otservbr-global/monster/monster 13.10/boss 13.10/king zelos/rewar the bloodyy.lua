local mType = Game.createMonsterType("Rewar The Bloodyy")
local monster = {}

monster.description = "a Rewar The Bloodyy"
...
monster.attacks = {
	...
	{name ="combat", interval = 1800, chance = 60, type = COMBAT_MANADRAIN, minDamage = -800, maxDamage = -1100, length = 7, spread = 2, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 1800, chance = 19, type = COMBAT_PHYSICALDAMAGE, minDamage = -600, maxDamage = -1300, length = 7, spread = 3, effect = CONST_ME_BLOCKHIT, target = false},
	{name ="combat", interval = 1800, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -600, maxDamage = -900, radius = 10, effect = 7, target = false},
	{name ="combat", interval = 2000, chance = 22, type = CONDITION_POISON, minDamage = -800, maxDamage = -1000, length = 8, spread = 3, effect = CONST_ME_POISONAREA, target = false}
}
