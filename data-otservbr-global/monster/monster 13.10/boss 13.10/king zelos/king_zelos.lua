...
monster.loot = {
	...
	{name = "mortal mace", chance = 800},
	{name = "golden hyaena pendant", chance = 1100},
	{name = "bow of cataclysm", chance = 300},
	{name = "galea mortis", chance = 300},
	{name = "shadow cowl", chance = 300},
	{name = "toga mortis", chance = 300},
}

monster.attacks = {
	{name = "melee", type = COMBAT_PHYSICALDAMAGE, interval = 2000, minDamage = -1500, maxDamage = -2700},
	{name = "combat", type = COMBAT_FIREDAMAGE, interval = 2000, chance = 15, length = 8, spread = 0, minDamage = -2400, maxDamage = -3200, effect = CONST_ME_HITBYFIRE},
	{name = "combat", type = COMBAT_LIFEDRAIN, interval = 2000, chance = 10, length = 8, spread = 3, minDamage = -1200, maxDamage = -1600, effect = CONST_ME_SMALLCLOUDS},
}
