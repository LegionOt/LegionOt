...
monster.attacks = {
	...
	{name ="combat", interval = 1800, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -900, radius = 10, effect = 7, target = false},
	{name ="combat", interval = 2000, chance = 22, type = CONDITION_POISON, minDamage = -700, maxDamage = -1200, length = 8, spread = 3, effect = CONST_ME_POISONAREA, target = false}
}
