local mType = Game.createMonsterType("Nargor The Impaler")
local monster = {}

monster.description = "a nargor the impaler"
...
monster.attacks = {
	...
	{name ="combat", interval = 1800, chance = 60, type = COMBAT_MANADRAIN, minDamage = -1000, maxDamage = -1500, length = 7, spread = 2, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 1800, chance = 19, type = COMBAT_PHYSICALDAMAGE, minDamage = -900, maxDamage = -1600, length = 7, spread = 3, effect = CONST_ME_BLOCKHIT, target = false},
	{name ="combat", interval = 1800, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -600, maxDamage = -1000, radius = 10, effect = 7, target = false},
	{name ="combat", interval = 2000, chance = 22, type = CONDITION_POISON, minDamage = -800, maxDamage = -1300, length = 8, spread = 3, effect = CONST_ME_POISONAREA, target = false}
}
