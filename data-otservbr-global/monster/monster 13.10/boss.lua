...
monster.defenses = {
	defense = 30,
	armor = 30,
	{name ="outfit", interval = 1000, chance = 864, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Azerus"},
	{name ="outfit", interval = 1000, chance = 795, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Apocalypse"},
	{name ="outfit", interval = 1000, chance = 831, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Bones"},
	{name ="outfit", interval = 1000, chance = 786, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Ferumbras"},
	{name ="outfit", interval = 1000, chance = 598, effect = CONST_ME_GROUNDSHAKER, target = false, duration = 700, outfitMonster = "Demon"},
