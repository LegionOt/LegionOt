local mType = Game.createMonsterType("Tnova")
local monster = {}
...
monster.voices = {
	interval = 5000,
	chance = 90,
	{text = "me la pelas puto! te va a cargar la verga!", yell = false},
	{text = "pinche ezequiel puto me baneaste!", yell = false}
}
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 2500, maxDamage = -999999, effect = CONST_ME_DRAWBLOOD, condition = {type = CONDITION_POISON, totalDamage = 20, interval = 4000}},
