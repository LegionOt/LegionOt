local c = {
    ...
    ['amount'] = 1,  ---  Price
    ['cost'] = 25000000,  ---  Item Quantity
    uniqueID = 39758  ---  Unique Id , do not forget add it on remeres map editor and on the end of this script
}
...
leverBuy:uid(39758) -- Unique id added on Remeres map editor
leverBuy:register()