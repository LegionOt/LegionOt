local outfits = {
    ...
    -- Config
        dollID = 39757, -- Change this to your dolls or items, item ID
    ...
    -- Outfit Table
        ...
        [2] = {name = "Royal Pumpkin", male = 760, female = 759},
        [3] = {name = "Sea Dog", male = 750, female = 749},
...
local addonsDollModal = TalkAction("!addon")
