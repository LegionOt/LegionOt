local addTournamentBalance = TalkAction("/tournament")

function addTournamentBalance.onSay(player, words, param)   
...
addTournamentBalance:separator(" ")
addTournamentBalance:register()