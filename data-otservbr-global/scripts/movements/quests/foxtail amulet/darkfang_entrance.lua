local config = {
	[32139] = {
		timeStorage = 228,
		range = 4,
		newPos = Position(33057, 31887, 9),
		bossName = 'darkfang',
		bossPos = Position(33062, 31891, 9)
	}
}

local darkfangEntrance = MoveEvent()

function darkfangEntrance.onStepIn(creature, item, position, fromPosition)
...
darkfangEntrance:type("stepin")
darkfangEntrance:aid(32139)
darkfangEntrance:register()