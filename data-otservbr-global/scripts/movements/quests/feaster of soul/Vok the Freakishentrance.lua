local config = {
	[32152] = {
		timeStorage = 232,
		range = 4,
		newPos = Position(33506, 31487, 9),
		bossName = 'Vok the Freakish',
		bossPos = Position(33510, 31494, 9)
	}
}

local VoktheFreakish = MoveEvent()

function VoktheFreakish.onStepIn(creature, item, position, fromPosition)
