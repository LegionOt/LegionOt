local config = {
	[32151] = {
		timeStorage = 231,
		range = 4,
		newPos = Position(33467, 31398, 8),
		bossName = 'Irgix the Flimsy',
		bossPos = Position(33467, 31404, 8)
	}
}

local IrgixtheFlimsy = MoveEvent()

function IrgixtheFlimsy.onStepIn(creature, item, position, fromPosition)
