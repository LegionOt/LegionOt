...
--------------------------------------------------------------------------------------
    ...
    [40898] = {name = "BOSSES", positions = {
  	{x = 32369, y = 32243, z = 7}, ---name= COMING SOON
  	{x = 32369, y = 32243, z = 7}, ---name= COMING SOON
...
--  {x = 32761, y = 32627, z = 7},	--NAME= CARNIVOROS
	...
	}, subareas = {'COMING SOON', 'COMING SOON', 'CYCLOPS THAIS', 'DRAGONS DARASHIA', 'DRAGONS POI', 'FERUMBRAS HUNT', 'DEMONS ORAMOND', 'GRIM REAPER YALAHAR', 'HELLSPAWN YALAHR', 'BANUTA', 'GAZES PORT HOPE', 'ROSHAMUUL', 'CATACOMBS ORAMOND', 'COBRAS', 'LIONS','FALCONS','LIONS DARASHIA','DRAKENS FAMINE','CARNIVOROS'}}
}
