local config = {
    ...
    level = 550, -- Minimum level to open the chest
...
local rewards = {
    ...
    { id = 3043, name = "Crystal Coins", count = 35, text = "25" },
    { id = 3043, name = "Crystal Coins", count = 40, text = "40" },
    { id = 22118, name = "Tibia coins", count = 150, text = "150" },
