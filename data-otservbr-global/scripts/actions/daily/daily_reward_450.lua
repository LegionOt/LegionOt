local config = {
    ...
    level = 450, -- Minimum level to open the chest
    capacity = 100 -- Minimum capacity required to take a reward (Set to heaviest item's weight)
}

local rewards = {
    { id = 3043, name = "Crystal Coins", count = 15, text = "15" },
    { id = 3043, name = "Crystal Coins", count = 20, text = "20" },
    { id = 3043, name = "Crystal Coins", count = 25, text = "25" },
    { id = 3043, name = "Crystal Coins", count = 30, text = "30" },
    { id = 3043, name = "Crystal Coins", count = 35, text = "35" },
    { id = 22118, name = "Tibia coins", count = 100, text = "100" },
