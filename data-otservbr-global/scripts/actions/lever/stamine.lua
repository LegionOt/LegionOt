local c = {
    ['item'] = 36725,  --- ID of the item
    ['amount'] = 1,  ---  Price
    ['cost'] = 10000000,  ---  Item Quantity
    uniqueID = 36725  ---  Unique Id , do not forget add it on remeres map editor and on the end of this script
}
...
leverBuy:uid(36725) -- Unique id added on Remeres map editor
leverBuy:register()