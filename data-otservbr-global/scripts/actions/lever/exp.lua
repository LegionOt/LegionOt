local c = {
    ['item'] = 36729,  --- ID of the item
    ['amount'] = 1,  ---  Price
    ['cost'] = 9000000,  ---  Item Quantity
    uniqueID = 36729  ---  Unique Id , do not forget add it on remeres map editor and on the end of this script
}
...
leverBuy:uid(36729) -- Unique id added on Remeres map editor
leverBuy:register()