local c = {
    ['item'] = 36019,  --- ID of the item
    ['amount'] = 1,  ---  Price
    ['cost'] = 20000000,  ---  Item Quantity
    uniqueID = 36019  ---  Unique Id , do not forget add it on remeres map editor and on the end of this script
}
...
leverBuy:uid(36019) -- Unique id added on Remeres map editor
leverBuy:register()