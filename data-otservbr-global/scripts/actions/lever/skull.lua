local c = {
    ['item'] = 37342,  --- ID of the item
    ['amount'] = 1,  ---  Price
    ['cost'] = 15000000,  ---  Item Quantity
    uniqueID = 37342  ---  Unique Id , do not forget add it on remeres map editor and on the end of this script
}
...
leverBuy:uid(37342) -- Unique id added on Remeres map editor
leverBuy:register()