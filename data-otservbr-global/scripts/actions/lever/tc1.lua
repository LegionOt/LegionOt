local c = {
    ...
    ['amount'] = 1,  ---  Price
    ['cost'] = 4000000,  ---  Item Quantity
    uniqueID = 37318  ---  Unique Id , do not forget add it on remeres map editor and on the end of this script
}
...
leverBuy:uid(37317) -- Unique id added on Remeres map editor
leverBuy:register()