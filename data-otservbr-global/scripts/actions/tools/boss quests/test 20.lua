...
local config = {
    ...
    timeStorage = 728, -- id of lever before pulled
    pulled_id = 1946 -- id of lever after pulled
}

local player_positions = {
    [1] = {fromPos = Position(33734, 31471, 14), toPos = Position(33711, 31464, 14)},
	[2] = {fromPos = Position(33735, 31471, 14), toPos = Position(33711, 31464, 14)},
	[3] = {fromPos = Position(33736, 31471, 14), toPos = Position(33711, 31464, 14)},
	[4] = {fromPos = Position(33737, 31471, 14), toPos = Position(33711, 31464, 14)},
	[5] = {fromPos = Position(33738, 31471, 14), toPos = Position(33711, 31464, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33708, 31465, 14), toPos = Position(33715, 31474, 14)},
    
}

function soulll555xArea()
   Game.createMonster("The Fear Feaster", Position(33711, 31469, 14))
   
    return 
end

local soulllx555 = Action()
function soulllx555.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  addEvent(soulll555xArea, 500)
    clearRoom(Position(33707, 31464, 14), Position(33716, 31475, 14), true)
    return true
end
	
soulllx555:uid(38471)
soulllx555:register()
