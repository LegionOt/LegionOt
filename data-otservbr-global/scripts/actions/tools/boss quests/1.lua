local config = {
		bosses = {
		{'Soul Scourge', 'Soul Scourge', 'Soul Scourge', 'Soul Scourge'},
		{'Soul Scourge', 'Soul Scourge', 'Soul Scourge', 'Soul Scourge'},
		{'Soul Scourge', 'Soul Scourge', 'Soul Scourge', 'Soul Scourge'},
		{'Soul Scourge', 'Soul Scourge', 'Soul Scourge', 'Soul Scourge'},
		{'Soul Scourge', 'Soul Scourge', 'Soul Scourge', 'Soul Scourge'},
	...
	positions = {
		...
		Position(33455, 31471, 13),
		Position(33455, 31474, 13),
		Position(33458, 31474, 13),
		Position(33458, 31471, 13)
    ...
    timeStorage = 7, -- id of lever before pulled
...
local player_positions = {
	[1] = {fromPos = Position(33455, 31493, 13), toPos = Position(33457, 31479, 13)},
	[2] = {fromPos = Position(33456, 31493, 13), toPos = Position(33457, 31479, 13)},
	[3] = {fromPos = Position(33457, 31493, 13), toPos = Position(33457, 31479, 13)},
	[4] = {fromPos = Position(33458, 31493, 13), toPos = Position(33457, 31479, 13)},
	[5] = {fromPos = Position(33459, 31493, 13), toPos = Position(33457, 31479, 13)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33451, 31467, 13), toPos = Position(33461, 31477, 13)},
    
}

function DukeKrulexArea()
   Game.createMonster("Duke Krule", Position(33457, 31472, 13))
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(DukeKrulexArea, 500)
    clearRoom(Position(33451, 31466, 13), Position(33461, 31479, 13), true)
    return true
end
