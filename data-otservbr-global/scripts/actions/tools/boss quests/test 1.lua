local config = {
    ...
    timeStorage = 709, -- id of lever before pulled
...
local player_positions = {
	[1] = {fromPos = Position(33676, 31634, 14), toPos = Position(33709, 31627, 14)},
	[2] = {fromPos = Position(33677, 31634, 14), toPos = Position(33709, 31627, 14)},
	[3] = {fromPos = Position(33678, 31634, 14), toPos = Position(33709, 31627, 14)},
	[4] = {fromPos = Position(33679, 31634, 14), toPos = Position(33709, 31627, 14)},
	[5] = {fromPos = Position(33680, 31634, 14), toPos = Position(33709, 31627, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33699, 31625, 14), toPos = Position(33719, 31642, 14)},
    
}

function test1xArea()
   Game.createMonster("Goshnar's Megalomania", Position(33710, 31632, 14))
 
	return	
end

local test1 = Action()
function test1.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(test1xArea, 500)
	clearRoom(Position(33699, 31625, 14), Position(33720, 31643, 14), true)
    return true
end
