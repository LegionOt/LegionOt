local config = {
	...
	positions = {
		-- other bosses
		Position(33899, 31365, 15),
		Position(33906, 31367, 15),
		
		Position(33901, 31371, 15),
		Position(33907, 31369, 15)
    ...
    timeStorage = 732, -- id of lever before pulled
...
local player_positions = {
	[1] = {fromPos = Position(33893, 31388, 15), toPos = Position(33900, 31373, 15)},
	[2] = {fromPos = Position(33894, 31388, 15), toPos = Position(33900, 31373, 15)},
	[3] = {fromPos = Position(33895, 31388, 15), toPos = Position(33900, 31373, 15)},
	[4] = {fromPos = Position(33896, 31388, 15), toPos = Position(33900, 31373, 15)},
	[5] = {fromPos = Position(33897, 31388, 15), toPos = Position(33900, 31373, 15)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33899, 31346, 14), toPos = Position(33911, 31356, 14)},
    
}

function test24xArea()
   Game.createMonster("Ratmiral Blackwhiskers", Position(33906, 31349, 14))
	Game.createMonster("Prub", Position(33902, 31363, 15))   
	Game.createMonster("Pirat Artillerist", Position(33897, 31373, 15))
	Game.createMonster("Pirat Artillerist", Position(33893, 31367, 15))
	Game.createMonster("Pirat Artillerist", Position(33910, 31373, 15))
	Game.createMonster("Pirat Artillerist", Position(33913, 31366, 15))
	
	Game.createMonster("Elite Pirat", Position(33904, 31351, 15))
	Game.createMonster("Elite Pirat", Position(33906, 31353, 15))
	Game.createMonster("Elite Pirat", Position(33901, 31354, 15))
	Game.createMonster("Elite Pirat", Position(33910, 31355, 15))
	
	Game.createMonster("Rateye Ric", Position(33905, 31348, 15))
	Game.createMonster("Rateye Ric", Position(33908, 31355, 15))
	Game.createMonster("Rateye Ric", Position(33900, 31345, 15))
	Game.createMonster("Rateye Ric", Position(33909, 31349, 15))	
 
	return	
end

local test24 = Action()
function test24.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(test24xArea, 500)
    clearRoom(Position(33900, 31347, 14), Position(33912, 31357, 14), true)
	 clearRoom(Position(33892, 31365, 15), Position(33912, 31373, 15), true)
	 clearRoom(Position(33906, 31374, 15), Position(33915, 31365, 15), true)
	 clearRoom(Position(33899, 31345, 15), Position(33912, 31357, 15), true)
    return true
end
