local config = {
    ...
    timeStorage = 712, -- id of lever before pulled
...
local player_positions = {
    [1] = {fromPos = Position(33774, 31634, 14), toPos = Position(33743, 31626, 14)},
	[2] = {fromPos = Position(33775, 31634, 14), toPos = Position(33743, 31626, 14)},
	[3] = {fromPos = Position(33776, 31634, 14), toPos = Position(33743, 31626, 14)},
	[4] = {fromPos = Position(33777, 31634, 14), toPos = Position(33743, 31626, 14)},
	[5] = {fromPos = Position(33778, 31634, 14), toPos = Position(33743, 31626, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33736, 31626, 14), toPos = Position(33748, 31640, 14)},
    
}

function test4xArea()
   Game.createMonster("Goshnar's Spite", Position(33742, 31631, 14))
 
	return	
end

local test4 = Action()
function test4.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(test4xArea, 500)
	clearRoom(Position(33733, 31624, 14), Position(33752, 31641, 14), true)
    return true
end
