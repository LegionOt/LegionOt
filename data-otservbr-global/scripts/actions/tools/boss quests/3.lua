local config = {
		bosses = {
		{'Soulless Minions', 'Soulless Minions'},
		{'Dark Druid', 'Dark Knight', 'Dark Paladin', 'Dark Sorcerer'},
		{'Soulless Minions', 'Soulless Minions'},
		{'Soulless Minions', 'Soulless Minions'},
		{'Dark Druid', 'Dark Knight', 'Dark Paladin', 'Dark Sorcerer'},
		{'Soulless Minions', 'Soulless Minions'},
	...
	positions = {
		-- other bosses
		Position(33454, 31436, 13),
		Position(33457, 31439, 13),
		
		Position(33450, 31437, 13),
		Position(33457, 31439, 13),
		Position(33453, 31436, 13),
		Position(33459, 31436, 13)
    ...
    timeStorage = 702, -- id of lever before pulled
...
local player_positions = {
	[1] = {fromPos = Position(33455, 31413, 13), toPos = Position(33456, 31430, 13)},
	[2] = {fromPos = Position(33456, 31413, 13), toPos = Position(33456, 31430, 13)},
	[3] = {fromPos = Position(33457, 31413, 13), toPos = Position(33456, 31430, 13)},
	[4] = {fromPos = Position(33458, 31413, 13), toPos = Position(33456, 31430, 13)},
	[5] = {fromPos = Position(33459, 31413, 13), toPos = Position(33456, 31430, 13)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33450, 31433, 13), toPos = Position(33461, 31442, 13)},
    
}

function soulllll55555123456xArea()
   Game.createMonster("Count Vlarkorth", Position(33456, 31438, 13))
 
	return	
end

local soulllllx55555123456 = Action()
function soulllllx55555123456.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(soulllll55555123456xArea, 500)
    clearRoom(Position(33448, 31434, 13), Position(33462, 31443, 13), true)
    return true
end
	
soulllllx55555123456:uid(60011)
soulllllx55555123456:register()