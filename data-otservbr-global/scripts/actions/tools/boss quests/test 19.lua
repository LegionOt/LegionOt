...
local config = {
    ...
    timeStorage = 727, -- id of lever before pulled
    pulled_id = 1946 -- id of lever after pulled
}

local player_positions = {
    [1] = {fromPos = Position(33736, 31537, 14), toPos = Position(33707, 31534, 14)},
	[2] = {fromPos = Position(33737, 31537, 14), toPos = Position(33707, 31534, 14)},
	[3] = {fromPos = Position(33738, 31537, 14), toPos = Position(33707, 31534, 14)},
	[4] = {fromPos = Position(33739, 31537, 14), toPos = Position(33707, 31534, 14)},
	[5] = {fromPos = Position(33740, 31537, 14), toPos = Position(33707, 31534, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33703, 31534, 14), toPos = Position(33712, 31545, 14)},
    
}

function soullll5555xArea()
   Game.createMonster("The Unwelcome", Position(33710, 31541, 14))
   
    return 
end

local soullllx5555 = Action()
function soullllx5555.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  addEvent(soullll5555xArea, 500)
    clearRoom(Position(33703, 31533, 14), Position(33713, 31546, 14), true)
    return true
end
	
soullllx5555:uid(38472)
soullllx5555:register()
