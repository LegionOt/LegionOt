...
local config = {
    ...
    timeStorage = 729, -- id of lever before pulled
    pulled_id = 1946 -- id of lever after pulled
}

local player_positions = {
    [1] = {fromPos = Position(33739, 31506, 14), toPos = Position(33712, 31497, 14)},
	[2] = {fromPos = Position(33740, 31506, 14), toPos = Position(33712, 31497, 14)},
	[3] = {fromPos = Position(33741, 31506, 14), toPos = Position(33712, 31497, 14)},
	[4] = {fromPos = Position(33742, 31506, 14), toPos = Position(33712, 31497, 14)},
	[5] = {fromPos = Position(33743, 31506, 14), toPos = Position(33712, 31497, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33707, 31498, 14), toPos = Position(33719, 31509, 14)},
    
}

function soulllll55555xArea()
   Game.createMonster("The Dread Maiden", Position(33714, 31505, 14))
   
    return 
end

local soulllllx55555 = Action()
function soulllllx55555.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  addEvent(soulllll55555xArea, 500)
    clearRoom(Position(33706, 31497, 14), Position(33720, 31510, 14), true)
    return true
end
	
soulllllx55555:uid(38473)
soulllllx55555:register()
