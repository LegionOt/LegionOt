local config = {
		bosses = {
		{'Condensed Sins', 'Condensed Sins', 'Condensed Sins', 'Condensed Sins'},
		{'Condensed Sins', 'Condensed Sins', 'Condensed Sins', 'Condensed Sins'},
		{'Condensed Sins', 'Condensed Sins', 'Condensed Sins', 'Condensed Sins'},
		{'Condensed Sins', 'Condensed Sins', 'Condensed Sins', 'Condensed Sins'},
		{'Condensed Sins', 'Condensed Sins', 'Condensed Sins', 'Condensed Sins'},
    ...
    timeStorage = 701, -- id of lever before pulled
...
local player_positions = {
    [1] = {fromPos = Position(33422, 31493, 13), toPos = Position(33424, 31480, 13)},
	[2] = {fromPos = Position(33423, 31493, 13), toPos = Position(33424, 31480, 13)},
	[3] = {fromPos = Position(33424, 31493, 13), toPos = Position(33424, 31480, 13)},
	[4] = {fromPos = Position(33425, 31493, 13), toPos = Position(33424, 31480, 13)},
	[5] = {fromPos = Position(33426, 31493, 13), toPos = Position(33424, 31480, 13)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33420, 31468, 13), toPos = Position(33429, 31478, 13)},
    
}

function soulllll5555512345678xArea()
   Game.createMonster("Lord Azaram", Position(33425, 31473, 13))
 
	return	
end

local soulllllx5555512345678 = Action()
function soulllllx5555512345678.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(soulllll5555512345678xArea, 500)
    clearRoom(Position(33419, 31467, 13), Position(33429, 31479, 13), true)
    return true
end
	
soulllllx5555512345678:uid(60010)
soulllllx5555512345678:register()