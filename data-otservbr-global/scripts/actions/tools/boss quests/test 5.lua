local config = {
    ...
    timeStorage = 713, -- id of lever before pulled
...
local player_positions = {
    [1] = {fromPos = Position(33854, 31854, 6), toPos = Position(33855, 31859, 7)},
	[2] = {fromPos = Position(33855, 31854, 6), toPos = Position(33855, 31859, 7)},
	[3] = {fromPos = Position(33856, 31854, 6), toPos = Position(33855, 31859, 7)},
	[4] = {fromPos = Position(33857, 31854, 6), toPos = Position(33855, 31859, 7)},
	[5] = {fromPos = Position(33858, 31854, 6), toPos = Position(33855, 31859, 7)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33851, 31858, 7), toPos = Position(33862, 31872, 7)},
    
}

function test5xArea()
   Game.createMonster("goshnar's cruelty", Position(33855, 31866, 7))
 
	return	
end

local test5 = Action()
function test5.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(test5xArea, 500)
	clearRoom(Position(33848, 31856, 7), Position(33863, 31875, 7), true)
    return true
end
