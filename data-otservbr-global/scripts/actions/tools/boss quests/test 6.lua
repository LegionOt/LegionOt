local config = {
    ...
    timeStorage = 714, -- id of lever before pulled
...
local player_positions = {
    [1] = {fromPos = Position(33776, 31665, 14), toPos = Position(33745, 31661, 14)},
	[2] = {fromPos = Position(33777, 31665, 14), toPos = Position(33745, 31661, 14)},
	[3] = {fromPos = Position(33778, 31665, 14), toPos = Position(33745, 31661, 14)},
	[4] = {fromPos = Position(33779, 31665, 14), toPos = Position(33745, 31661, 14)},
	[5] = {fromPos = Position(33780, 31665, 14), toPos = Position(33745, 31661, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33741, 31659, 14), toPos = Position(33752, 31673, 14)},
    
}

function test6xArea()
   Game.createMonster("Goshnar's Greed", Position(33747, 31666, 14))
 
	return	
end

local test6 = Action()
function test6.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(test6xArea, 500)
	clearRoom(Position(33738, 31657, 14), Position(33754, 31674, 14), true)
    return true
end
