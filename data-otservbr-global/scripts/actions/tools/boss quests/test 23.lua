...
local player_positions = {
	[1] = {fromPos = Position(34048, 31709, 10), toPos = Position(34031, 31694, 10)},
	[2] = {fromPos = Position(34047, 31709, 10), toPos = Position(34032, 31694, 10)},
	[3] = {fromPos = Position(34046, 31709, 10), toPos = Position(34033, 31694, 10)},
	[4] = {fromPos = Position(34045, 31709, 10), toPos = Position(34035, 31694, 10)},
	[5] = {fromPos = Position(34044, 31709, 10), toPos = Position(34036, 31694, 10)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(34024, 31684, 10), toPos = Position(34039, 31693, 10)},
    
}

function test23xArea()
   Game.createMonster("Ahau", Position(34031, 31687, 10))
 
	return	
end

local test23 = Action()
function test23.onUse(player, item, fromPosition, target, toPosition, isHotkey)
