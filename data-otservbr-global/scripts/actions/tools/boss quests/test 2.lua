local config = {
    ...
    timeStorage = 710, -- id of lever before pulled
...
local player_positions = {
    [1] = {fromPos = Position(33679, 31599, 14), toPos = Position(33708, 31592, 14)},
	[2] = {fromPos = Position(33680, 31599, 14), toPos = Position(33708, 31592, 14)},
	[3] = {fromPos = Position(33681, 31599, 14), toPos = Position(33708, 31592, 14)},
	[4] = {fromPos = Position(33682, 31599, 14), toPos = Position(33708, 31592, 14)},
	[5] = {fromPos = Position(33683, 31599, 14), toPos = Position(33708, 31592, 14)}
}


local configg = {
    maxPlayers = 0,
    room = {fromPos = Position(33700, 31590, 14), toPos = Position(33717, 31607, 14)},
    
}

function test2xArea()
   Game.createMonster("Goshnar's Malice", Position(33709, 31600, 14))
 
	return	
end

local test2 = Action()
function test2.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
if #getPlayersInArea(configg.room.fromPos, configg.room.toPos) > configg.maxPlayers then
  ...
  if player:getStorageValue(config.timeStorage) > os.time() then
	...
	addEvent(test2xArea, 500)
	clearRoom(Position(33698, 31589, 14), Position(33717, 31608, 14), true)
    return true
end
